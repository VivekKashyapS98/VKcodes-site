  ...
  return (
    ...
    >
      ...
      <div className="container m-auto dark:text-gray-100">
        <header className="h-20 flex flex-row px-4 justify-between items-center">
          <h1
            className="text-3xl font-bold font-mono md:text-4xl cursor-pointer"
            onClick={() => router.push("/")}
          >
            VKcodes
          </h1>
      ...
      <footer className="bg-gray-100 flex flex-col dark:bg-gray-700 dark:text-gray-100">
        <h1
          className="text-3xl mt-2 ml-2 md:mt-4 md:ml-4 font-bold font-mono md:text-4xl cursor-pointer"
          onClick={() => router.push("/")}
        >
          VKcodes
        </h1>
