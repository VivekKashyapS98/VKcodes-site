...
export default function Layout({ toggle, theme, children }: any) {
  ...
  return (
    ...
    >
      ...
      <header className="h-20 sticky z-10 bg-white top-0 border-b-2 border-gray-200 backdrop-filter backdrop-blur-lg bg-opacity-10 firefox:bg-opacity-50 flex flex-row px-4 justify-between items-center dark:bg-gray-700 dark:firefox:bg-opacity-50 dark:bg-opacity-10 dark:text-gray-100">
        <Link href="/" passHref>
